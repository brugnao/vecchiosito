...
// process a new shipping address
    if (tep_not_null($HTTP_POST_VARS['firstname']) && tep_not_null($HTTP_POST_VARS['lastname']) && tep_not_null($HTTP_POST_VARS['street_address'])) {
      ...
      //PIVACF end
      //BERSANI start
	  if (ACCOUNT_COMPANY_CF== 'true') $company_cf = tep_db_prepare_input($HTTP_POST_VARS['company_cf']);
      //BERSANI end
...
<?php
      ...
      $addresses_query = tep_db_query("select address_book_id, entry_firstname as firstname, entry_lastname as lastname, entry_company as company, entry_piva as piva, entry_cf as cf, entry_company_cf as company_cf, entry_street_address as street_address, entry_suburb as suburb, entry_city as city, entry_postcode as postcode, entry_state as state, entry_zone_id as zone_id, entry_country_id as country_id from " . TABLE_ADDRESS_BOOK . " where customers_id = '" . (int)$customer_id . "'");
      //PIVACF-BERSANI end
