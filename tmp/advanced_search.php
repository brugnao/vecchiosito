...
?>              
             ...
             <tr>
                <td class="fieldKey"><?php echo ENTRY_SPECIALS; ?></td>
                <td class="fieldValue"><?php echo tep_draw_checkbox_field('specials','si'); ?></td>
              </tr> 
             <tr>
                <td class="fieldKey"><?php echo ENTRY_NEWPRODUCTS; ?></td>
                <td class="fieldValue"><?php echo tep_draw_checkbox_field('newproducts','si'); ?></td>
              </tr> 
            </table></td>
          </tr>
        </table></td>
