...
*/
	$products_price=$pws_prices->getHtmlPriceWithDiscount($products_new['products_id']);
//PWS eof
?>
          <tr>
            <td width="<?php echo SMALL_IMAGE_WIDTH + 10; ?>" valign="top" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_new['products_id']) . '">' . $GLOBALS['pws_html']->getHtmlProductsImage($products_new['products_id'], $products_new['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>'; ?></td>
