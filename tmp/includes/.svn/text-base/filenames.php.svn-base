...
// define the filenames used in the project
  ...
  define('FILENAME_DEFAULT_SPECIALS', 'specials.php');
...
//_GD_XLSE start
define('FILENAME_XLS_CATALOGUE_EXPORT', 'export_csv.php');
//_GD_XLSE stop
// member login
define('FILENAME_LOGIN_WELCOME', 'memberlogin.php');
...
define('FILENAME_REQUEST_PRODUCT_INFO', 'request_product_info.php');

// config cache
define('FILENAME_CONFIGURATION_CACHE', 'cache/cachefile.inc.php') ; 

// termini e condizioni di vendita nella fase di checkout
 define('FILENAME_POPUP_TERMS_CONDITIONS_HELP', 'popup_terms_conditions.php');
