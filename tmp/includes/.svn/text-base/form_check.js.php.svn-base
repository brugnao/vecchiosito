...
<? 
if ( ALLOW_FINAL_CUSTOMERS == 'false')
   $entry_type = 'company';
...
function set_entry_type(type){
	var thediv=document.getElementById('companydiv');
	entry_type=type;
	if (thediv){
		if (type=="company"){
...
if (ACCOUNT_CF_REQ == 'true' ) echo '  if (entry_type==\'private\')check_input("cf", 0, "' . ENTRY_CF_ERROR . '");' . "\n"; 
?>
<?php if (ACCOUNT_PIVA_REQ == 'true') echo '  if (entry_type==\'company\')check_input("piva", 0, "' . ENTRY_PIVA_ERROR . '");' . "\n"; ?>
//PIVACF end
//BERSANI start
<?php if (ACCOUNT_COMPANY_CF_REQ == 'true') echo '  if (entry_type==\'company\')check_input("company_cf", 0, "' . ENTRY_COMPANY_CF_ERROR . '");' . "\n"; ?>
//BERSANI end
...
//PrivacyStart
<?php if (ACCOUNT_PRIVACY == 'true') echo '  check_radio("privacy_accept", "' . ENTRY_PRIVACY_ERROR . '");' . "\n"; ?>
//PrivacyEnd
