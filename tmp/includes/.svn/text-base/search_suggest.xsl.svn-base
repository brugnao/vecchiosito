...
<xsl:template match="/">
 ...
 <xsl:for-each select="response/suggestlist/item">
  <tr onmouseover="myrow = this.getElementsByTagName('td').item(0); myrow.style.backgroundColor = '#000099';" onmouseout="myrow = this.getElementsByTagName('td').item(0); myrow.style.backgroundColor = '#FFFFFF';">
   <td onclick="window.location.href = '{url}';" style="cursor: pointer; border: 1px solid #CCCCCC; font-size: 8pt; font-family: Verdana; margin-left: 0; color: #000000">
   	<img>
