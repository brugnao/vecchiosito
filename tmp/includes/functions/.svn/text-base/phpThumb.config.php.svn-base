...
//$PHPTHUMB_CONFIG['cache_directory'] = DIR_FS_CATALOG.DIR_WS_IMAGES.'imagecache/';                            // set the cache directory relative to the phpThumb() installation

$PHPTHUMB_CONFIG['cache_directory'] = DIR_FS_CATALOG.DIR_WS_CACHE;                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_source_directory'] = DIR_FS_CATALOG.DIR_WS_IMAGES.'imagecache/';  // set the cache directory for unprocessed source images
...
$PHPTHUMB_CONFIG['output_format']    = null; // default output format ('jpeg', 'png' or 'gif') - thumbnail will be output in this format (if available in your version of GD). This is always overridden by ?f=___ GETstring parameter
