...
define('TABLE_HEADING_SPECIALS', 'Our Specials');
...
define('ENTRY_TYPE','Customer Type:');
define('ENTRY_TYPE_COMPANY','Company');
define('ENTRY_TYPE_PRIVATE','Single Customer');
...
//PIVACF start
define('ENTRY_PIVA', 'Tax ID:');
define('ENTRY_PIVA_ERROR', 'Invalid tax id.');
define('ENTRY_PIVA_TEXT', '*');
define('ENTRY_CF', 'Vat Number:');
define('ENTRY_CF_TEXT', '*');
define('ENTRY_CF_ERROR', 'Invalid Vat Number.');
//PIVACF end
// BERSANI start
define('ENTRY_COMPANY_CF','Company Vat Number:');
define('ENTRY_COMPANY_CF_TEXT', '*');
define('ENTRY_COMPANY_CF_ERROR', 'Invalid Company Vat Number.');
// BERSANI stop
...
//Add these lines to your main language file
//PRIVACY start
require(DIR_WS_LANGUAGES . $language . '/privacy.php');
define('MUST_AGREE_TO_PRIVACY', 'Privacy');
define('AGREE', 'Agree');
define('NOT_AGREE', 'Not Agree');
define('TEXT_PRIVACY_INFORMATION' , $TEXT_PRIVACY_INFORMATION);
define('ENTRY_PRIVACY_ERROR', 'To register you must agree to the privacy statement.');
//PRIVACY end
// Easy polulate
define('BOX_CATALOG_IMP_EXP', 'Import Export Utility');
// END
//MOD_PRICES bof
define('TEXT_LOGIN_REQUIRED','Please login for prices');
//MOD_PRICES eof
// AVAILABILITY start
define('LEGEND_AVAILABILITY_GREEN','Full availability');
define('LEGEND_AVAILABILITY_YELLOW','Scarce availability');
define('LEGEND_AVAILABILITY_RED','To be ordered');
define('LEGEND_AVAILABILITY_SCHEDULED','Incoming');
define('LEGEND_AVAILABILITY','Availability Legend');
// AVAILABILITY stop
...
*/
define('FOOTER_TEXT_BODY', 'Copyright &copy; 2008 <a href="http://www.oscommerce.it" target="_blank">osCommerce PWS</a><br>Powered by <a href="http://www.oscommerce.it" target="_blank">Power Web Studio</a>');
