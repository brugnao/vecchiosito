...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_DP_MODULE_TITLE', 'PayPal Express Checkout Payment module');
  define('MODULE_PAYMENT_PAYPAL_EC_TEXT_TITLE', 'PayPal');
...
// definitiopn of the OR

  define('MODULE_PAYMENT_PAYPAL_EC_SHORTCUT_OR', '- OU -');
  
  define('MODULE_PAYMENT_PAYPAL_EC_MARK_TEXT', 'Save time. Checkout securely.<br>Pay without sharing your financial information.');
