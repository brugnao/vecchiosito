 ...
 */	
	function SEO_URL_INSTALLER(){
		...
		$this->default_config['SEO_ENABLED'] = array('DEFAULT' => 'true',
												     'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Abilita SEO URLs?', 'SEO_ENABLED', 'true', 'Abilitare URL SEO ?  Questa &egrave; un''impostazione globale e li disabiliter&agrave; del tutto.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
												     );
		$x++;
		$this->default_config['SEO_ADD_CPATH_TO_PRODUCT_URLS'] = array('DEFAULT' => 'false',
		   															   'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Aggiungere cPath agli URL prodotti ?', 'SEO_ADD_CPATH_TO_PRODUCT_URLS', 'false', 'Questa impostazione aggiunger&agrave; cPath in coda agli URL dei prodotti (p.es:- il-mio-prodotto-p-1.html?cPath=xx).', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
																		);
		$x++;
		$this->default_config['SEO_ADD_CAT_PARENT'] = array('DEFAULT' => 'true',
		   													'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Aggiungere categoria all''inizio degli URL?', 'SEO_ADD_CAT_PARENT', 'true', 'Questa impostazione aggiunger&agrave; il nome della categoria all''inizio degli URL delle categorie (p.es.: - categoria-prova-c-1.html).', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
															);
		$x++;
		$this->default_config['SEO_URLS_FILTER_SHORT_WORDS'] = array('DEFAULT' => '3',
		   															 'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Scarta le Parole Corte', 'SEO_URLS_FILTER_SHORT_WORDS', '3', 'Questa impostazione scarter&agrave; le parole di meno o esattamente il numero di lettere inserito, dal nome dell''URL.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, NULL)"
																	);
		$x++;
		$this->default_config['SEO_URLS_USE_W3C_VALID'] = array('DEFAULT' => 'true',
		   													                 'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Genera URL validi per W3C ?', 'SEO_URLS_USE_W3C_VALID', 'true', 'Questa impostazione abilita la generazione di url validi per lo standard W3C.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
																	         );
		$x++;
		$this->default_config['USE_SEO_CACHE_GLOBAL'] = array('DEFAULT' => 'true',
		   													  'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Abilita la cache SEO ?', 'USE_SEO_CACHE_GLOBAL', 'true', 'Questa &egrave; un''impostazione globale e disabiliter&agrave; completamente l''uso della cache.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
															  );
		$x++;
		$this->default_config['USE_SEO_CACHE_PRODUCTS'] = array('DEFAULT' => 'true',
																'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Abilita la cache prodotti ?', 'USE_SEO_CACHE_PRODUCTS', 'true', 'Questa impostazione disabiliter&agrave; la cache per i prodotti.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
																);
		$x++;
		$this->default_config['USE_SEO_CACHE_CATEGORIES'] = array('DEFAULT' => 'true',
		   														  'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Abilita la cache categorie ?', 'USE_SEO_CACHE_CATEGORIES', 'true', 'Questa impostazione disabiliter&agrave; la cache per le categorie.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
																  );

		$x++;
		$this->default_config['USE_SEO_CACHE_MANUFACTURERS'] = array('DEFAULT' => 'true',
		   															 'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Abilita la cache produttori ?', 'USE_SEO_CACHE_MANUFACTURERS', 'true', 'Questa impostazione disabiliter&agrave; la cache per i produttori.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
																	 );

		$x++;
		$this->default_config['USE_SEO_CACHE_ARTICLES'] = array('DEFAULT' => 'true',
		   														'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Abilita la cache articoli ?', 'USE_SEO_CACHE_ARTICLES', 'true', 'Questa impostazione disabiliter&agrave; la cache per gli articoli.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
																);
		$x++;
		$this->default_config['USE_SEO_CACHE_TOPICS'] = array('DEFAULT' => 'true',
		   													  'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Abilita la cache argomenti ?', 'USE_SEO_CACHE_TOPICS', 'true', 'Questa impostazione disabiliter&agrave; la cache per gli argomenti degli articoli', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
															  );
		$x++;
		$this->default_config['USE_SEO_CACHE_INFO_PAGES'] = array('DEFAULT' => 'true',
		   														  'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Abilita la cache Page Manager ?', 'USE_SEO_CACHE_INFO_PAGES', 'true', 'Questa impostazione disabiliter&agrave; la cache per le pagine di Page Manager.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
																  );
		$x++;
		$this->default_config['USE_SEO_REDIRECT'] = array('DEFAULT' => 'true',
		   												  'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Abilita redirects automatici?', 'USE_SEO_REDIRECT', 'true', 'Questa impostazione attiva il redirect automatico e manda il codice http 301 per segnalare il passaggio da un URL vecchio ad uno nuovo.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
														  );
		$x++;
		$this->default_config['SEO_REWRITE_TYPE'] = array('DEFAULT' => 'Rewrite',
		   												  'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Seleziona Metodo Riscrittura URL', 'SEO_REWRITE_TYPE', 'Rewrite', 'Scegliere il tipo di URL SEL da utilizzare.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''Rewrite''),')"
														  );
		$x++;
		$this->default_config['SEO_CHAR_CONVERT_SET'] = array('DEFAULT' => '',
		   													  'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Conversione di caratteri speciali', 'SEO_CHAR_CONVERT_SET', '', 'Questa impostazione converte i caratteri.<br><br>Il formato <b>DEVE</b> essere nella forma: <b>carattere1=>conversione1,carattere2=>conversione2</b>', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, NULL)"
															  );
		$x++;
		$this->default_config['SEO_REMOVE_ALL_SPEC_CHARS'] = array('DEFAULT' => 'false',
		   														   'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Scartare i caratteri non-alfanumerici?', 'SEO_REMOVE_ALL_SPEC_CHARS', 'false', 'Questa impostazione rimuove tutti i caratteri che non sono n&eacute; lettere n&eacute; numeri. Potrebbe essere utile per scartare i caratteri speciali con 1 impostazione.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')"
																	);
		$x++;
		$this->default_config['SEO_URLS_CACHE_RESET'] = array('DEFAULT' => 'false',
		   													  'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('', 'Resetta la Cache SEO URL', 'SEO_URLS_CACHE_RESET', 'false', 'Questa impostazione resetter&agrave; i dati memorizzati nella cache per SEO', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), 'tep_reset_cache_data_seo_urls', 'tep_cfg_select_option(array(''reset'', ''false''),')"
															  );
		$this->init();
...
//			if ( $this->attributes['USE_SEO_CACHE_INFO_PAGES'] == 'true' && defined('TABLE_INFORMATION')) $this->generate_information_cache();
			if ( $this->attributes['USE_SEO_CACHE_INFO_PAGES'] == 'true' && defined('TABLE_PAGES_DESCRIPTION')) $this->generate_pages_cache();		
