...
//PIVACF start
<?php if (ACCOUNT_CF_REQ == 'true') echo '  if (form.elements["country"].value!=105) check_input("cf", 0, "' . ENTRY_CF_ERROR . '");' . "\n"; ?>
<?php if (ACCOUNT_PIVA_REQ == 'true') echo '  if (form.elements["country"].value!=105) check_input("piva", 0, "' . ENTRY_PIVA_ERROR . '");' . "\n"; ?>
//PIVACF end
//BERSANI start
<?php if (ACCOUNT_COMPANY_CF_REQ == 'true') echo '  if (form.elements["country"].value!=105) check_input("company_cf", 0, "' . ENTRY_COMPANY_CF_ERROR . '");' . "\n"; ?>
//BERSANI end
