...
*/
  ...
  $pws_engine->triggerHook('CATALOG_LOGOFF');

  
  // tep_session_unregister('customer_country_id');
  // tep_session_unregister('customer_zone_id');
  tep_session_unregister('comments');
    tep_session_unregister('customer_compani_cf');
    tep_session_unregister('customer_piva');
  ...
  // paypal express mark
   tep_session_unregister('ppec_mode');
   session_destroy();
  
  
  $cart->reset();
  
  // distruggi cookie 'yes',0,'/');
