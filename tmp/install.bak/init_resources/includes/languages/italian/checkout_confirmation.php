...
//---PayPal WPP Modification START ---//
  define('MODULE_PAYMENT_PAYPAL_DP_TEXT_TITLE', 'PayPal Pagamento Diretto');
  define('MODULE_PAYMENT_PAYPAL_EC_TEXT_TITLE', 'Checkout Espresso tramite PayPal');
//---PayPal WPP Modification END---//
// Pure B2B
define('HEADING_ORDER_CONTACT', 'Ordine effetuato da: ');
define('HEADING_ORDER_REFERENCE', 'VS Riferimento Ordine: ');

// popup termini e condizioni di utilizzo
define('TEXT_TERMS_CONDITIONS_LINK', 'Termini e Condizioni di Vendita');
define('ALERT_TEXT_CONDITIONS','Perfavore accetta le condizioni di vendita !');
