...
define('EMAIL_TEXT', 'Adesso puoi usufruire dei <b>molti servizi</b> che ti offriamo. Alcuni fra questi sono:' . "\n\n" . '<li><b>Carrello acquisti</b> - Qualsiasi prodotto aggiunto al tuo carrello vi rimarr&agrave; fino a che non lo rimuoverete o lo acquistarete.' . "\n" . '<li><b>Rubrica personale</b> - Ora possiamo spedirvi prodotti ad indirizzi differenti da quello con cui avete creato l\'accout. Questa soluzione &egrave; perfetta per spedire regali di compleanno direttamente al festeggiato.' . "\n" . '<li><b>Storico ordini</b> - Visualizza la cronologia degli acquisti che hai fatto.' . "\n" . '<li><b>Recensioni prodotti</b> - Condividi le tue opinioni riguardo a prodotti con altri nostri clienti.' . "\n\n");
...
define('EMAIL_WARNING', '<b>Note:</b> Questo indirizzo email &egrave; stato utilizzato da un nostro cliente. Se non hai scelto tu di iscriverti, per piacere contattaci all\'indirizzo ' . STORE_OWNER_EMAIL_ADDRESS . '.' . "\n");

//---PayPal WPP Modification START ---//
define('EMAIL_EC_ACCOUNT_INFORMATION', 'Grazie per avere usato il Checkout Espresso di PayPal!  Per renderle le prossime visite ancora più comode, è stato creato un acconto utente per lei.  Ecco le sue nuove informazioni di login :' . "\n\n");
