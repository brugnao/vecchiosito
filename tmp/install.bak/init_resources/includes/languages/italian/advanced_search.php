...
define('TEXT_SEARCH_HELP', 'Le parole chiave devono essere separate da AND oppure OR per stabilire un buon controllo dei risultati.<br><br>Per esempio, <u>Microsoft AND mouse</u> generer&agrave; risultati che conterranno entrambe le parole. Invece, inserendo <u>mouse OR keyboard</u>, si generer&agrave; una lista che contiene prodotti che hanno sia entrambe le parole oppure una delle due..<br><br>E\' inoltre possibile visualizzare i risultati esatti comprendendo le parole fra virgolette..<br><br>Per esempio, <u>\"notebook computer\"</u> si otterr&agrave; una lista di prodotti che hanno la stringa esatta al loro interno.<br><br>Le parentesi possono essere usate per controllare l\'ordine degli operatori logici.<br><br>Per esempio, &egrave; possibile inserire <u>Microsoft and (tastiere or mouse or \"visual basic\")</u>.');
