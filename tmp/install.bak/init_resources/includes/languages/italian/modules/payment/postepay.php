...
*/
  ...
  define('MODULE_PAYMENT_POSTEPAY_TEXT_DELIVERY', 'Non appena verr&agrave; contabilizzata la ricarica, provvederemo immediatamente alla spedizione della merce ordinata.');
