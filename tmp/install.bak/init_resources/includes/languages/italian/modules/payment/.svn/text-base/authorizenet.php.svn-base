...
*/
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_ERROR_MESSAGE', 'Si &egrave; verificato un errore nel procedimento di controllo della carta di credito, riprova.');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_DECLINED_MESSAGE', 'La tua carta di credito non &egrave; valida. Prova con un\'altra carta oppure contatta la tua banca per ulteriori informazioni.');
