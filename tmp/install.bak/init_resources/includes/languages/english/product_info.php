...
// costi stimati di spedizione
define('ESTIMATED_SHIPPING_COST_FOR', 'Estimated Shipping Costs For ');
define('FREE_SHIPPING_TITLE', 'Free Shipping');
// link aggiornamenti prodotto
define('PRODUCT_NOTIFICATIONS', 'Notify product update');
define('PRODUCT_NOTIFICATIONS_REMOVE', 'Remove from product update');

define('REQUEST_PRODUCT_INFORMATIONS', 'Ask for more info about this product');
?>
