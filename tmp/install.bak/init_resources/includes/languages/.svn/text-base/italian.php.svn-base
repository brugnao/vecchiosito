...
define('TABLE_HEADING_SPECIALS', 'Le nostre Offerte Speciali');
...
// _GD_XSLE stop
define('BOX_INFORMATION_XLS_CATALOGUE', 'Catalogo in formato Excel');
// _GD_XSLE stop

define('BOX_HEADING_PAGES', 'Informazioni');
...
define('CATEGORY_TYPE', 'Tipo utente');
...
define('ENTRY_TYPE','Cliente:');
define('ENTRY_TYPE_COMPANY','Azienda');
define('ENTRY_TYPE_PRIVATE','Privato');
...
define('ENTRY_CITY_ERROR', 'Il campo \"Citt&agrave;\" deve contentere minimo ' . ENTRY_CITY_MIN_LENGTH . ' caratteri.');
define('ENTRY_CITY_TEXT', '*');
define('ENTRY_STATE', 'Provincia:');
define('ENTRY_STATE_ERROR', 'Il campo \"Stato/Provincia\" deve contentere minimo ' . ENTRY_STATE_MIN_LENGTH . ' caratteri.');
define('ENTRY_STATE_ERROR_SELECT', 'Seleziona uno Stato/Provincia del men&ugrave; a scorrimento.');
define('ENTRY_STATE_TEXT', '*');
define('ENTRY_COUNTRY', 'Nazione:');
define('ENTRY_COUNTRY_ERROR', 'Seleziona una Nazione del men&ugrave; a scorrimento.');
...
// vetrina e nuovo product listing
define('IMAGE_BUTTON_DETAILS', 'Dettagli');
...
define('ERROR_TEP_MAIL', '<font face="Verdana, Arial" size="2" color="#ff0000"><b><small>ERRORE TEP:</small> Non &egrave; possibile inviare email, non &egrave; stato specificato SMTP server. Cerca php.ini e configura SMTP server.</b></font>');
...
define('WARNING_CONFIG_FILE_WRITEABLE', 'Attenzione: E\' possibile scrivere sul file di configurazione: ' . dirname($HTTP_SERVER_VARS['SCRIPT_FILENAME']) . '/includes/configure.php. Questo &egrave; un rischio - configura tale file in sola lettura.');
...
define('TEXT_CCVAL_ERROR_INVALID_DATE', 'La data di scadenza della carta di credito non &egrave; corretta.<br/>Controlla la data e riprova.');
define('TEXT_CCVAL_ERROR_INVALID_NUMBER', 'Il numero della carta di credito immesso &egrave; invalido.<br/>Controlla il numero e riprova.');
...
define('MUST_AGREE_TO_PRIVACY', 'Privacy');
define('AGREE', 'Accetto');
define('NOT_AGREE', 'Non Accetto');
define('TEXT_PRIVACY_INFORMATION' , $TEXT_PRIVACY_INFORMATION);
define('ENTRY_PRIVACY_ERROR', 'Per registrarsi &egrave; obbligatorio accettare le condizioni sulla Privacy.');
//PRIVACY end
...
// END
// AVAILABILITY start
define('LEGEND_AVAILABILITY_GREEN','Disponibilit&agrave; piena');
define('LEGEND_AVAILABILITY_YELLOW','Disponibilit&agrave; scarsa');
define('LEGEND_AVAILABILITY_RED','Su ordinazione');
define('LEGEND_AVAILABILITY_SCHEDULED','In arrivo');
define('LEGEND_AVAILABILITY','Legenda Disponibilit&agrave;');
// AVAILABILITY stop
...
*/
define('FOOTER_TEXT_BODY', 'Copyright &copy; 2008 <a href="http://www.oscommerce.it" target="_blank">osCommerce PWS</a><br/>Powered by <a href="http://www.oscommerce.it" target="_blank">Power Web Studio</a><br/>Tutti i marchi che appaiono in questo sito appartengono ai rispettivi proprietari.');

//kgt - discount coupons
define('ENTRY_DISCOUNT_COUPON_ERROR', 'Il codice dello sconto inserito non &egrave; valido');
define('ENTRY_DISCOUNT_COUPON_AVAILABLE_ERROR', 'Il codice dello sconto inserito non &egrave; pi&ugrave; valido');
define('ENTRY_DISCOUNT_COUPON_USE_ERROR', 'Il nostro registro mostra che il codice dello sconto che &egrave; stato inserito &egrave; gi&agrave; stato utilizzato %s volta(e).  Quel codice &egrave; utilizzabile al pi&ugrave; %s volta(e).');
define('ENTRY_DISCOUNT_COUPON_MIN_PRICE_ERROR', 'L\'ordine mininmo totale per usufruire di questo codice sconto &egrave; pari a %s');
define('ENTRY_DISCOUNT_COUPON_MIN_QUANTITY_ERROR', 'Il minimo numero di articoli richiesti per potere usufruire di questo codice sconto &egrave; pari a %s');
define('ENTRY_DISCOUNT_COUPON_EXCLUSION_ERROR', 'Alcuni o tutti gli articoli inseriti nel carrello sono esclusi da questo codice sconto' );
define('ENTRY_DISCOUNT_COUPON', 'Codice Sconto Coupon:');
define('ENTRY_DISCOUNT_COUPON_SHIPPING_CALC_ERROR', 'Le spese di spedizioni calcolate sono state aggiornate.');
