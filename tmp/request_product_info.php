...
*/
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_REQUEST_PRODUCT_INFO);
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'process')) {
    ...
    if ($error == false) {
      $email_subject = sprintf(TEXT_EMAIL_SUBJECT, $from_name, $product_info['products_name']);
...
<!-- body_text //-->
    <td width="100%" valign="top"><?php echo tep_draw_form('email_friend', tep_href_link(FILENAME_REQUEST_PRODUCT_INFO, 'action=process&products_id=' . $HTTP_GET_VARS['products_id'])); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              <tr class="infoBoxContents">
                <td><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="main"><?php echo tep_draw_input_field('from_name', $from_name, 'size="30"','', true); ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo FORM_FIELD_CUSTOMER_EMAIL; ?></td>
                    <td class="main"><?php echo tep_draw_input_field('from_email_address', $from_email_address, 'size="40"', '', true); ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
          ...
          <tr>
            <td class="main"><b><?php echo FORM_TITLE_MESSAGE; ?></b></td>
          </tr>
          <tr>
            <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
              <tr class="infoBoxContents">
