...
/******************************************************************************/
	...
	define('PDF_TITLE','Catalogo online ');
	...
	//pix to mm factor
	define('PDF_TO_MM_FACTOR',3);//0.3526);
	...
	// Increase or decrease according to the height of your
	// thumbnail images.
	...
	// Addition - set to 0 always - there is now no reason at all to attempt
	//to use the resize function, which is covered by thumbnailing the image
