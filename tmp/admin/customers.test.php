  ...
  if (tep_not_null($action)) {
    switch ($action) {
      case 'update':
        ...
        if (NULL!=$pws_engine->getPlugin('pws_prices_customers_groups','prices')){
...
//PIVACF end
// BERSANI start
<?php if (ACCOUNT_COMPANY_CF_REQ == 'true') {
?>
  if (document.customers.elements['entry_company_cf'].value == "") {
