...
*/
  ...
  class order {
    ...
    function query($order_id) {
	  ...
	  // order_refernce order_contact start
	...
	// questa è universale e non da problemi di colonne mancanti
    	$order_query = tep_db_query("select * from " . TABLE_ORDERS . " where orders_id = '" . (int)$order_id . "'");
    	// order_refernce order_contact end
      //PIVACF-BERSANI end
      ...
      $this->billing = array('name' => $order['billing_name'],
                             ...
                             'customer_type' => $order['billing_type'],
     						 'contact' => $order['Ordine_effetuato_da'],						
      						 'reference' => $order['Vs_rif_ordine'],
