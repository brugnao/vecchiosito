...
//PWS bof
									.'<br><a href="' . tep_href_link(FILENAME_MODULES, 'set=prices', 'NONSSL') . '" class="menuBoxContentLink">'. BOX_MODULES_PRICES. '</a>'
									.'<br><a href="' . tep_href_link(FILENAME_MODULES, 'set=application', 'NONSSL') . '" class="menuBoxContentLink">'. BOX_MODULES_APPLICATION. '</a>'
//PWS eof
    );
  }
