...
define('TEXT_PRODUCTS_SHOPWINDOW','Mostrare in vetrina');
define('TEXT_YES', 'Si');
define('TEXT_NO', 'No');

define('TEXT_PRODUCTS_ONLYSHOW','Solo Catalogo <br>(non viene mostrato il prezzo ma solo richiesta info)');
...
define('TEXT_PRODUCTS_WEIGHT', 'Peso del prodotto (in Kg)<br> necessario per il calcolo delle spese di spedizione:');
...
define('ERROR_CANNOT_MOVE_CATEGORY_TO_PARENT', 'Errore: Questa categoria non pu&ograve; essere mossa in usa sotto-categoria.');
  define('TEXT_PRODUCTS_REORDER', 'Livello di Riordino:');
   define('TEXT_PRODUCTS_REORDER_TO', 'Qta di Riordino.:');

// youtube
define('TEXT_PRODUCTS_YOUTUBE', 'Inserisci il link di youtube');   
define('TEXT_PRODUCTS_YOUTUBE_URL', 'Copia e incolla l\'url fornito da youtube per es. <br>http://www.youtube.com/watch?v=XYZXYZXYZ' );  
?>
