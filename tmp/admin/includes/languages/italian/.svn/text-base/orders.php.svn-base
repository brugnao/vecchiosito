...
define('HEADING_ORDER_NUMBER', 'Ordine Numero: ');
...
define('ENTRY_PRINTABLE', 'Stampa Distinta');
...
define('EMAIL_TEXT_INVOICE_URL', 'Dettagli Distinta:');
...
define('EMAIL_TEXT_COMMENTS_UPDATE', 'I commenti per il tuo ordine sono %s');
...
define('CUSTOMER_CODE', '<b>Codice Cliente</b>: ');
define('CUSTOMER_GROUP', '<b>Gruppo Clienti</b>: ');
define('ORDER_CONTACT', '<b>Ordine Effettuato da</b>: ');
define('ORDER_REFERENCE', '<b>Riferimento Ordine Cliente</b>: ');
