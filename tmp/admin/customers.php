      ...
      if ($error == false) {
        ...
        if (($customers_group_id >= '1')) // modifica siltel
        {
        	...
        	$message_body = 'Gentile Cliente,
					la sua richiesta di attivazione sul ns. sito è stata completata, può cominciare da subito ad effettuare i suoi ordini accedendo con l\'e-mail e la password da lei scelta in fase di registrazione.
...
<?php
  	...
  	// Elenco principale dei clienti, me raccomando non ce lo mette un commento...troppo facile da trovÃ  su 1400 righe de codice
...
<?php  // BOF customer_sort_admin_v1 adapted for Separate Pricing Per Customer
          ...
          ?>
             <td valign="top">
                ...
                <? // solo se il customer code Ã¨ abilitato
