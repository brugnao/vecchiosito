  ...
  if ($VARS['action']=="Add") {
    ...
    if (($inputok)) {
      ...
      if (tep_db_num_rows($q)>0) {
        ...
        tep_db_query("insert into " . TABLE_PRODUCTS_STOCK . " (`products_id`,`products_stock_attributes`,`products_stock_quantity`) values (" . (int)$VARS['product_id'] . ",'$val'," . (int)$VARS['quantity'] . ")");
      }
...
<tr><td><br>
<?php  echo '<a href="' . tep_href_link(FILENAME_CATEGORIES, '', 'NONSSL') . '" class="menuBoxContentLink">Categorie</a> &nbsp;&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_STATS_LOW_STOCK_ATTRIB, '', 'NONSSL') . '" class="menuBoxContentLink">Report sui prodotti sotto scorta</a>';?>
</td></tr>
    </table></td>
<!-- body_text_eof //-->
  </tr>
