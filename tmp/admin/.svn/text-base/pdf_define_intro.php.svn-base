<?php
/*
  $Id: pdf_define_intro.php based on define_mainpage.php,v 1.2 2002/04/06 00:00:00 mattice Exp $
...
<!--                <td class="main"><b><?php echo $HTTP_GET_VARS['filename']; ?></b></td> -->
              ...
              <tr>
                <td class="main"><?php echo tep_draw_textarea_field('file_contents', 'soft', '120', '30', $file_contents, (($file_writeable) ? '' : 'readonly')); ?></td>
              </tr>
              <tr>
