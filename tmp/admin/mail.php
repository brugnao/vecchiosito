...
/*
   	...
   	print ( $message);
  	*/
	$mail_go = tep_mail($mail['customers_firstname'] . ' ' . $mail['customers_lastname'], $mail['customers_email_address'], 		$subject,			 $message, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);

	/*	if(!$mail_go)
			die ("impossibile inviare email ". $mail_go);
*/
