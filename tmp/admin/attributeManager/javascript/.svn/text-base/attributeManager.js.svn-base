...
function checkBox(id) {
    ...
    if(check[id] != true) //if a value is not true, use this rather than == false, 'cos the first time no value will be set and it will be undefined, not true or false
        {
        document.getElementById('imgCheck_' + id).src = "attributeManager/images/icon_checked.gif"; // change the image
        ...
        {
        document.getElementById('imgCheck_' + id).src = "attributeManager/images/icon_unchecked.gif";
